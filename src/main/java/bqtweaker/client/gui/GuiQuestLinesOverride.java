...
public class GuiQuestLinesOverride extends GuiScreenCanvas implements IPEventListener, INeedsRefresh
{
    ...
    public void initPanel()
    {
        ...
        CanvasTextured cvTopBar = new CanvasTextured(new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(0, 0, 0, -24 - 8 /*different themes*/), 0), PresetTexture.PANEL_MAIN.getTexture());
        cvBackground.addPanel(cvTopBar);
        
        PanelButton btnExit = new PanelButton(new GuiTransform(GuiAlign.BOTTOM_LEFT, 2 + 6 /*different themes*/, -24, 16, 16, 0), -1, "").setIcon(PresetIcon.ICON_PG_PREV.getTexture());
        ...
        if(canEdit)
        {
            PanelButton btnEdit = new PanelButton(new GuiTransform(GuiAlign.BOTTOM_LEFT, 2 + 6 /*different themes*/, -40, 16, 16, 0), -1, "").setIcon(PresetIcon.ICON_GEAR.getTexture());
        ...
        icoChapter = new PanelGeneric(new GuiTransform(GuiAlign.TOP_LEFT, 16, 5 + 3 /*different themes*/, 16, 16, 0), null);
        cvTopBar.addPanel(icoChapter);
        
        txTitleScroll = new CanvasScrolling(new GuiTransform(GuiAlign.HALF_LEFT, new GuiPadding(44, 4 + 4 /*different themes*/, 3 - 1 /*different themes*/, 2 + 4 /*different themes*/), 0));
        ...
        txDescScroll = new CanvasScrolling(new GuiTransform(GuiAlign.HALF_RIGHT, new GuiPadding(3 - 1 /*different themes*/, 4 + 4 /*different themes*/, 4 + 2 /*different themes*/, 2 + 4 /*different themes*/), 0));
        ...
        cvFrame = new CanvasHoverTray(new GuiTransform(GuiAlign.FULL_BOX, new GuiPadding(150 + 24, 32, 8, 8), 0), new GuiTransform(GuiAlign.FULL_BOX, new GuiPadding(150 + 24 + 6 /*different themes*/, 32, 8, 8), 0), PresetTexture.AUX_FRAME_0.getTexture());
        ...
        cvChapterTray = new CanvasEmpty(new GuiRectangle(18 + 6 /*different themes*/, 24, 164, cvFrame.getTransform().getHeight()+16));
        ...
        PanelButton fitView = new PanelButton(new GuiTransform(GuiAlign.TOP_LEFT, 2 + 6 /*different themes*/, 72-16-8, 16, 16, -2), 5, "");
        ...
        claimAll = new PanelButton(new GuiTransform(GuiAlign.TOP_LEFT, 2 + 6 /*different themes*/, 56-16-8, 16, 16, -2), -1, "");
        ...
        cvQuestPopup = new CanvasEmpty(new GuiTransform(GuiAlign.FULL_BOX, new GuiPadding(0, 0, 0, 0), 0)){
        	...
        	public boolean onMouseClick(int mx, int my, int click) {
            	...
            	if(canEdit && click == 1){
            		PopContextMenu popup = new PopContextMenu(new GuiRectangle(mx, my, RenderUtils.getStringWidth("Designer", Minecraft.getMinecraft().fontRenderer)+12, cvQuest.getButtonAt(mx, my) != null ? 32 : 16), true);
            		...
            		if(cvQuest.getButtonAt(mx, my) != null) {
	            		...
	            		popup.addButton("Edit", null, actionEditor);
            		}
            		...
            		popup.addButton("Designer", null, actionDesigner);
            		openPopup(popup);
            		return true;
            	}
            	else return false;
